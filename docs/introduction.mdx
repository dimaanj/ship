...
We use [Turborepo](https://turborepo.org/docs) for managing monorepo. To run infra and all services -- just run: `npm run start` 🚀

### Learn key concepts

Learn about Ship [architecture](/architecture) and key components([Web](/web/overview), [API](/api-reference/overview), [Deployment](/deployment/digital-ocean-apps), [Migrator](/migrator), [Scheduler](/scheduler).
